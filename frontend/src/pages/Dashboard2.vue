<template>
  ...
  <div>
    ...
    <!-- Tab content -->
    <div v-else-if="activeTab === 'tab2'" class="tabs-content">
...
const tabs = [
  { id: 'tab1', label: 'Personal', content: 'This is the content for Tab 1.' },
  { id: 'tab2', label: 'Overall', content: 'This is the content for Tab 2.' },
]
